-- Public enquiry form: read-only venue/options RPCs and secure anonymous submission.
...
GRANT EXECUTE ON FUNCTION public.get_public_enquiry_form_options(uuid) TO anon, authenticated;
