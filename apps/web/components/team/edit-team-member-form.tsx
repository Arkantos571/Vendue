  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <section className="v-panel dark:bg-stone-900">
        <h2 className="text-base font-semibold text-stone-900 dark:text-stone-100">Personal details</h2>
      ...
      <section className="v-panel dark:bg-stone-900">
        <h2 className="text-base font-semibold text-stone-900 dark:text-stone-100">Role & employment</h2>
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
      ...
      <section className="v-panel dark:bg-stone-900"><h2 className="text-base font-semibold text-stone-900 dark:text-stone-100">Notes</h2><div className="mt-5"><Textarea id="notes" name="notes" rows={4} defaultValue={member.notes ?? ""} /></div></section>
      <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
        <Link href={`/dashboard/team/${member.id}`} className="inline-flex h-10 items-center justify-center rounded-lg border border-stone-300 bg-white px-4 text-sm font-medium text-stone-900 hover:bg-stone-50 dark:border-stone-700 dark:bg-stone-900 dark:text-stone-100">Cancel</Link>
