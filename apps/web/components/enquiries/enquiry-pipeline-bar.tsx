  ...
  return (
    <div className="v-card p-4 sm:p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm font-medium text-foreground/90">Sales pipeline</p>
        {isLost && (
          <span className="inline-flex w-fit items-center rounded-full bg-muted px-3 py-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              ...
              <div className="flex items-center gap-2 sm:flex-col">
                <span
                  className={cn(
                    ...
                    isUpcoming && "border-slate-200 bg-white text-muted-foreground ",
                  )}
