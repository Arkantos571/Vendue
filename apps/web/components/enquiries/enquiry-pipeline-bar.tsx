  ...
  return (
    <div className="v-card p-4 sm:p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Sales pipeline</p>
        {isLost && (
          <span className="inline-flex w-fit items-center rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-300 dark:bg-slate-800">
              ...
              <div className="flex items-center gap-2 sm:flex-col">
                <span
                  className={cn(
                    ...
                    isUpcoming && "border-slate-200 bg-white text-stone-400 dark:border-slate-700 dark:bg-slate-900",
                  )}
