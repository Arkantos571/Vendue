  ...
  if (isLoadingVenues) {
    return (
      <div className="v-panel">
        <p className="text-sm text-stone-500 dark:text-stone-400">Loading enquiry form…</p>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      {showVenueSelector && (
        <section className="v-panel">
          <h2 className="text-base font-semibold text-stone-900 dark:text-stone-100">Venue</h2>
      ...
      <section className="v-panel">
        <h2 className="text-base font-semibold text-stone-900 dark:text-stone-100">Your details</h2>
