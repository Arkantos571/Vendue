    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {enquiry.proposalClientMessage && (
          <div>
            <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Client message</p>
            <p className="mt-2 whitespace-pre-wrap rounded-lg bg-slate-50 px-4 py-3 text-sm text-foreground/90">
              {enquiry.proposalClientMessage}
            </p>
          </div>
        )}
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          {showBuilderLink && (
            <Link
              ...
              className="inline-flex h-10 items-center rounded-lg border border-slate-300 bg-white px-4 text-sm font-medium text-foreground hover:bg-slate-50 dark:hover:bg-slate-800"
            >
