  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <section className="v-panel">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Core information for this booking.</p>
      ...
      <section className="v-panel">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Primary contact for this event.</p>
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <div className="space-y-2 sm:col-span-2">
      ...
      <section className="v-panel">
        ...
        <p className="mt-1 text-sm text-muted-foreground">When and where the event takes place.</p>
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
      ...
      <section className="v-panel">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Operational notes for your team.</p>
        <div className="mt-5">
          <Textarea
            id="notes"
            name="notes"
      ...
      <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
        <Link
          ...
          className="inline-flex h-10 items-center justify-center rounded-lg border border-slate-300 bg-card px-4 text-sm font-medium text-foreground hover:bg-muted"
        >
          Cancel
        </Link>
