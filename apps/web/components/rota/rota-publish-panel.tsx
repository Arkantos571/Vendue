  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h3 className="text-sm font-semibold text-foreground">Publish rota</h3>
      ...
      <dl className="grid grid-cols-2 gap-3 text-sm">
        <div>
          ...
          <dd className="font-medium text-foreground">{labourSummary.assignedStaff}</dd>
        </div>
        <div>
          <dt className="text-xs text-muted-foreground">Staffing gaps</dt>
          <dd className="font-medium text-foreground">{labourSummary.remainingGaps}</dd>
        </div>
        <div>
          <dt className="text-xs text-muted-foreground">Scheduled hours</dt>
      ...
      {hasShifts && !isPublished && (
        <p className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-muted-foreground dark:border-slate-700">
