  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        {items.length === 0 ? (
          <p className="text-sm text-muted-foreground">No running order items yet.</p>
        ) : (
          items.map((item, index) => (
            ...
            >
              <div className="sm:col-span-2">
                <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-muted-foreground">Time</label>
                <Input
                  value={item.time}
              ...
              <div className="sm:col-span-3">
                <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-muted-foreground">Activity</label>
                <Input
                  value={item.activity}
              ...
              <div className="sm:col-span-2">
                <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-muted-foreground">Owner / team</label>
                <Input
                  value={item.owner}
