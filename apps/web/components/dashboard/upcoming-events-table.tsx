              ...
              {events.map((event) => (
                ...
                >
                  <td className="px-6 py-4">
                    ...
                    <p className="mt-0.5 text-xs text-muted-foreground">Starts {event.startsAt}</p>
                  </td>
        ...
        <div className="space-y-3 p-4 sm:hidden">
          {events.map((event) => (
            <Link
              ...
              className="block rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50/80 hover:bg-muted"
            >
