  ...
  return (
    <DashboardShell title="Edit enquiry" description={enquiry.eventName}>
      <div className="mx-auto max-w-3xl space-y-6">
        <Link href={`/dashboard/enquiries/${enquiryId}`} className="inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:text-foreground">
