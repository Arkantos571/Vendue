  ...
  return (
    <DashboardShell title="Edit event" description={event.title}>
      <div className="mx-auto max-w-3xl space-y-6">
        <Link href={`/dashboard/events/${eventId}`} className="inline-flex items-center gap-1.5 text-sm font-medium text-stone-600 hover:text-stone-900 dark:text-stone-400 dark:hover:text-stone-100">
