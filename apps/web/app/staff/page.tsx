      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-3">
          <Link
            ...
            className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-4 py-4 text-sm font-medium text-foreground shadow-sm transition-colors hover:border-brand-200 dark:hover:border-brand-900"
          >
            Manage availability
